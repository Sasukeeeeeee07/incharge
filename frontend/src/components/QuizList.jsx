        ...
        {quizzes.map((quiz) => (
          <div key={quiz._id} className="p-4 space-y-4 active:bg-white/[0.05]">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm text-text-secondary">
              ...
              <div>
                <span className="block text-[10px] uppercase font-bold tracking-widest opacity-60 mb-1">Generated By</span>
                <span className="text-text-primary font-medium">Manual</span>
              </div>
            </div>
